...
INSTALLED_APPS = [
    ...
    # 'allauth.socialaccount.providers.google', # 구글 로그인 구현시 추가
    "allauth.socialaccount.providers.kakao",  # 카카오 로그인 구현시 추가
...
# 사용자가 로그인 버튼을 클릭했을 때 redirect URI로 오는 GET 오청만으로도 자동 로그인
SOCIALACCOUNT_LOGIN_ON_GET = True
ACCOUNT_LOGOUT_REDIRECT_URL = "/" # 로그아웃한 뒤에 어느 페이지로 리다이렉트할지 경로를 설정
...
SOCIALACCOUNT_PROVIDERS = {
    ...
    "kakao": {
        ...
        "AUTH_PARAMS": {
            ...
            "prompt": "select_account",  # 추가 간편 로그인을 지원해줌
        },
    }
}